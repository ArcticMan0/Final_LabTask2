...
export default function StudentDetail({
  ...
  const handleRemove = () => {
    ...
    const doRemove = async () => {
      try {
        ...
        Alert.alert(
          "Error",
          "Could not remove student. Is the server running?",
        );
      }
    };
  ...
  return (
    <View style={styles.card}>
      ...
      {/* FIX: The Remove button had no accessibility props.
                 Screen reader could not identify it as an interactive element.
                 Added: accessibilityRole="button", accessibilityLabel with student name,
                 and accessibilityHint explaining the confirmation dialog. */}
      <Pressable
